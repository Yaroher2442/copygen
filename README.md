...
[<img id="copygen" alt="Copygen Logo" src=".github/logo.svg" width="512"/>](https://github.com/Yaroher2442/copygen#copygen)

---

[![GoDoc](https://img.shields.io/badge/godoc-reference-5272B4.svg?style=for-the-badge&logo=appveyor&logo=appveyor)](https://pkg.go.dev/github.com/Yaroher2442/copygen)
[![License](https://img.shields.io/github/license/switchupcb/copygen.svg?style=for-the-badge)](https://github.com/Yaroher2442/copygen/blob/main/LICENSE)
...
```
go install github.com/Yaroher2442/copygen@latest
```

Install a specific version by specifying a branch.
```
go install github.com/Yaroher2442/copygen@main
```

Install a specific version by specifying a tag.
```
go install github.com/Yaroher2442/copygen@v0.4.0
```
...
```go
// Code generated by github.com/Yaroher2442/copygen
// DO NOT EDIT.
...
import (
	...
	"github.com/Yaroher2442/copygen/examples/main/domain"
	"github.com/Yaroher2442/copygen/examples/main/models"
)
...
_Check out more usecases in real-world examples using [Copygen Usecases](https://github.com/Yaroher2442/copygen/discussions/categories/usecases)._
